...
## Project Structure
    ...
    ├── payments_module_qa__54499  # Django project configurations
...
1. Clone this repo and `cd payments_module_qa__54499`
...
2. Clone this repo and `cd payments_module_qa__54499`
